...
public interface ESRestAPIConnection {
	...
	// String index, String type, String fieldName,
	// String term) throws DataAccessException;

	// public abstract String performQuery(String basicAuth, String baseurl,
	// G_EntityQuery q) throws DataAccessException;
	//
	// public abstract String performQuery(final String basicAuth, final String

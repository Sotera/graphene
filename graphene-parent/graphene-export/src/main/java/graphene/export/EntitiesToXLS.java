...
public class SingleSidedEventsToXLS {
	private static Logger logger = LoggerFactory
			.getLogger(SingleSidedEventsToXLS.class);

	public void toXLS(SingleSidedEvents lt, OutputStream out,
		...
		if (rowsWithinBounds) {
			...
			for (SingleSidedEventRow r : lt.getRows()) {
				...
				dt = new DateTime(0, row, new Date(r.getDateMilliSeconds()),
						dateFormat);
				account = new Label(1, row, r.getAccount());

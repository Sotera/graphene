...
public class G_PatternSearchResults extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public G_PatternSearchResults() {}

  /**
   * All-args constructor.
   */
  public G_PatternSearchResults(java.lang.Long total, java.util.List<graphene.model.idl.G_PatternSearchResult> results) {
    this.total = total;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 1: results = (java.util.List<graphene.model.idl.G_PatternSearchResult>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   * array of Items (Entities or Links) with scores   */
  public java.util.List<graphene.model.idl.G_PatternSearchResult> getResults() {
    return results;
  }
   ...
   */
  public void setResults(java.util.List<graphene.model.idl.G_PatternSearchResult> value) {
    this.results = value;
  }

  /** Creates a new G_PatternSearchResults RecordBuilder */
  public static graphene.model.idl.G_PatternSearchResults.Builder newBuilder() {
    return new graphene.model.idl.G_PatternSearchResults.Builder();
  }
  
  /** Creates a new G_PatternSearchResults RecordBuilder by copying an existing Builder */
  public static graphene.model.idl.G_PatternSearchResults.Builder newBuilder(graphene.model.idl.G_PatternSearchResults.Builder other) {
    return new graphene.model.idl.G_PatternSearchResults.Builder(other);
  }
  
  /** Creates a new G_PatternSearchResults RecordBuilder by copying an existing G_PatternSearchResults instance */
  public static graphene.model.idl.G_PatternSearchResults.Builder newBuilder(graphene.model.idl.G_PatternSearchResults other) {
    return new graphene.model.idl.G_PatternSearchResults.Builder(other);
  }
  
  /**
   * RecordBuilder for G_PatternSearchResults instances.
   */
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<G_PatternSearchResults>
    implements org.apache.avro.data.RecordBuilder<G_PatternSearchResults> {
    ...
    private Builder() {
      super(graphene.model.idl.G_PatternSearchResults.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(graphene.model.idl.G_PatternSearchResults.Builder other) {
      super(other);
    ...
    /** Creates a Builder by copying an existing G_PatternSearchResults instance */
    private Builder(graphene.model.idl.G_PatternSearchResults other) {
            super(graphene.model.idl.G_PatternSearchResults.SCHEMA$);
      if (isValidValue(fields()[0], other.total)) {
        this.total = data().deepCopy(fields()[0].schema(), other.total);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'total' field */
    public graphene.model.idl.G_PatternSearchResults.Builder setTotal(long value) {
    ...
    public graphene.model.idl.G_PatternSearchResults.Builder clearTotal() {
    ...
    /** Sets the value of the 'results' field */
    public graphene.model.idl.G_PatternSearchResults.Builder setResults(java.util.List<graphene.model.idl.G_PatternSearchResult> value) {
    ...
    public graphene.model.idl.G_PatternSearchResults.Builder clearResults() {
      results = null;
    ...
    @Override
    public G_PatternSearchResults build() {
      try {
        G_PatternSearchResults record = new G_PatternSearchResults();
        record.total = fieldSetFlags()[0] ? this.total : (java.lang.Long) defaultValue(fields()[0]);
        record.results = fieldSetFlags()[1] ? this.results : (java.util.List<graphene.model.idl.G_PatternSearchResult>) defaultValue(fields()[1]);
        return record;
      } catch (Exception e) {

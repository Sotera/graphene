...
public interface G_DataAccess {
  ...
  graphene.model.idl.G_SearchResults findByQuery(graphene.model.idl.G_EntityQuery pq) throws org.apache.avro.AvroRemoteException;
  /** Moved from GenericDAO (non IDL) */
...
@SuppressWarnings("all")
  ...
  public interface Callback extends G_DataAccess {
    ...
    /** Moved from GenericDAO (non IDL) */
    void findByQuery(graphene.model.idl.G_EntityQuery pq, org.apache.avro.ipc.Callback<graphene.model.idl.G_SearchResults> callback) throws java.io.IOException;
    /** Moved from GenericDAO (non IDL) */

...
public class G_SearchResult extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public G_SearchResult(java.lang.Double score, java.lang.Object result, java.util.Map<java.lang.String,java.util.List<graphene.model.idl.G_Property>> namedProperties) {
    this.score = score;
    this.result = result;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 2: namedProperties = (java.util.Map<java.lang.String,java.util.List<graphene.model.idl.G_Property>>)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  /**
   * Gets the value of the 'namedProperties' field.
   * Experimental, to get away from the setAdditionalProperties() problem   */
  public java.util.Map<java.lang.String,java.util.List<graphene.model.idl.G_Property>> getNamedProperties() {
    return namedProperties;
  }

  /**
   * Sets the value of the 'namedProperties' field.
   * Experimental, to get away from the setAdditionalProperties() problem   * @param value the value to set.
   */
  public void setNamedProperties(java.util.Map<java.lang.String,java.util.List<graphene.model.idl.G_Property>> value) {
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<G_SearchResult>
    ...
    private Builder(graphene.model.idl.G_SearchResult.Builder other) {
      ...
      if (isValidValue(fields()[2], other.namedProperties)) {
        this.namedProperties = data().deepCopy(fields()[2].schema(), other.namedProperties);
    ...
    /** Sets the value of the 'namedProperties' field */
    public graphene.model.idl.G_SearchResult.Builder setNamedProperties(java.util.Map<java.lang.String,java.util.List<graphene.model.idl.G_Property>> value) {
    ...
    /** Checks whether the 'namedProperties' field has been set */
    public boolean hasNamedProperties() {
      return fieldSetFlags()[2];
    }
    
    /** Clears the value of the 'namedProperties' field */
    public graphene.model.idl.G_SearchResult.Builder clearNamedProperties() {
    ...
    public G_SearchResult build() {
      try {
        ...
        record.namedProperties = fieldSetFlags()[2] ? this.namedProperties : (java.util.Map<java.lang.String,java.util.List<graphene.model.idl.G_Property>>) defaultValue(fields()[2]);
        return record;
      } catch (Exception e) {

...
public interface G_PatternSearch {
  ...
  java.lang.Object searchByExample(graphene.model.idl.G_PatternDescriptor example, java.lang.String service, long start, long max, graphene.model.idl.G_BoundedRange dateRange, boolean useAptima) throws org.apache.avro.AvroRemoteException;
  /** Returns a set of sub-graphs based on specified pattern from the Pattern Library
	 ...
	 @param dateRange	optional global date filter for results
	 @return			either results, or a future object (use getResults or the FutureResults service) */
  java.lang.Object searchByTemplate(java.lang.String template, java.lang.String service, long start, long max, graphene.model.idl.G_BoundedRange dateRange) throws org.apache.avro.AvroRemoteException;
  /** Block until all results are available.
	 ...
	 @param future		the future returned from the original call
	 @return 			the results */
  graphene.model.idl.G_PatternSearchResults getResults(graphene.model.idl.G_Future future) throws org.apache.avro.AvroRemoteException;
  /** Returns a list of available patterns templates in the existing pattern library.
	 ...
	 @return */
  java.util.List<graphene.model.idl.G_PatternDescriptor> getPatternTemplates() throws org.apache.avro.AvroRemoteException;
  /** Returns a list of available patterns templates in the existing pattern library.
	 ...
	 @return */
  java.util.List<graphene.model.idl.G_Service> getServices() throws org.apache.avro.AvroRemoteException;

  @SuppressWarnings("all")
  /** This defines an API for searching a graph-like database based on patterns. */
  public interface Callback extends G_PatternSearch {
    public static final org.apache.avro.Protocol PROTOCOL = graphene.model.idl.G_PatternSearch.PROTOCOL;
    /** Set a timeout for the task.
    ...
    /** Returns a set of sub-graphs based on specified user-defined example.
	 ...
	 @param dateRange	optional global date filter for results
	 @return			either results, or a future object (use getResults or the FutureResults service) */
    void searchByExample(graphene.model.idl.G_PatternDescriptor example, java.lang.String service, long start, long max, graphene.model.idl.G_BoundedRange dateRange, boolean useAptima, org.apache.avro.ipc.Callback<java.lang.Object> callback) throws java.io.IOException;
    /** Returns a set of sub-graphs based on specified pattern from the Pattern Library
	 ...
	 @param dateRange	optional global date filter for results
	 @return			either results, or a future object (use getResults or the FutureResults service) */
    void searchByTemplate(java.lang.String template, java.lang.String service, long start, long max, graphene.model.idl.G_BoundedRange dateRange, org.apache.avro.ipc.Callback<java.lang.Object> callback) throws java.io.IOException;
    /** Block until all results are available.
	 ...
	 @param future		the future returned from the original call
	 @return 			the results */
    void getResults(graphene.model.idl.G_Future future, org.apache.avro.ipc.Callback<graphene.model.idl.G_PatternSearchResults> callback) throws java.io.IOException;
    /** Returns a list of available patterns templates in the existing pattern library.
	 ...
	 @return */
    void getPatternTemplates(org.apache.avro.ipc.Callback<java.util.List<graphene.model.idl.G_PatternDescriptor>> callback) throws java.io.IOException;
    /** Returns a list of available patterns templates in the existing pattern library.
	 ...
	 @return */
    void getServices(org.apache.avro.ipc.Callback<java.util.List<graphene.model.idl.G_Service>> callback) throws java.io.IOException;
  }
}
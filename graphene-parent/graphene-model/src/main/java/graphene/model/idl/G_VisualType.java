...
public enum G_VisualType {
	HELP, TOP, CHART, DEFAULT, GRAPH, HIDDEN, IMAGE, INFINITE_SCROLL, LIST, MONEY, PLUGIN, SEARCH, TEXT, WEBGL, EVENT, META, DEMO, REDACTED, GEO, EXPERIMENTAL, SETTINGS, ADMIN
}

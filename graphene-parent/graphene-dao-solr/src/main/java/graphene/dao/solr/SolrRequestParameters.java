...
public class SolrRequestParameters {
   ...
   /**
    *
    * @param rows number of rows the query going to get if the rows is not set,
   ...
   /**
    *
    * @param resultFields result fields that query should return. same as solr
    * query "fl" filter
    */

...
/**
 * ExtendedBeanSerialzier outputs primary key based equals, hashCode and
...
public class ExtendedBeanSerializer extends BeanSerializer {
	...
	protected void bodyEnd(EntityType model, CodeWriter writer)
		...
		for (Property property : model.getProperties()) {
			columnToProperty.put(property.getAnnotation(Column.class).value(),
					property);
		}
		...
		writer.line("}");
		writer.line(model.getSimpleName(), " obj = (", model.getSimpleName(),
				")o;");

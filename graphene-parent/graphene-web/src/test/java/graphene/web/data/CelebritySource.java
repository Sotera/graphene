...
/**
 * An implementaition of the GridDataSource, so that Tapestry grids can get the
 * information they need. This is kind of a mid-model--not a domain object but
 * also not as simple as most view objects (which I tend to think of as POJOs or
 * beans).
 * 
...
public class CelebritySource implements GridDataSource {
	...
	public CelebritySource(IDataSource ds) {
		this.dataSource = ds;
		this.celebrities = ds.getAllCelebrities();
		this.cgds = new CollectionGridDataSource(celebrities);

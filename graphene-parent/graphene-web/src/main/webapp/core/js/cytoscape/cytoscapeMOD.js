...
/**
 * 12/04/13 - MODIFIED BY MIKE MARTINET
 * MOdified $$.registerInstance function  starting at line 1231
 * 
		...
		r.registerBinding(window, "mousemove", function(e) {
			...
			if (!capture) {
				...
				var containerPageCoords = r.findContainerPageCoords();
                                ...
                                // MFM DEBUG
                                //console.log("mm: containerPageCoords[0] = " + containerPageCoords[0] + ", containerPageCoords[1] = " + containerPageCoords[1] +
                                //", clientWidth = " + r.data.container.clientWidth + ", clientHeight = " + r.data.container.clientHeight + 
                                //" mpageX = " + e.pageX + ", mpageY =" + e.pageY);

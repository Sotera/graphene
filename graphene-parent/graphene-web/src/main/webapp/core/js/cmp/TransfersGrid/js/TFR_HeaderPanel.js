...
Ext.define('TransferHeaderModel', {
...
Ext.define("DARPA.customerDetails", {
	...
	update:function(header) {
		...
		this.items.items[1].setValue(header.customerAddress);        	
	}
...
Ext.define("DARPA.headerPanel",{
    	...
    	loadHeader:function(acno)
	{
		...
		this.headerStore.load( {
			...
			{
			// TODO: Check for and handle failure
...
// Now get the transactions				
				var ledger = getTransfersFrame().getLedger(acno);

				...
				"DARPA.GraphToolbar",
				{
					...
					constructor : function(config) {
						...
						var save_graph = {
							...
							text : "Save",
							height : myHeight,
							handler : (typeof config.saveHandler !== "undefined") ? config.saveHandler
									: function(item) {
										var gr = item.up().up();
						...
						var load_graph = {
							...
							text : "Load",
							height : myHeight,
							handler : (typeof config.loadHandler !== "undefined") ? config.loadHandler
									: function(item) {
										var gr = item.up().up();
						...
						var import_graph = {
							...
							text : "Import",
							height : myHeight,
							handler : (typeof config.importHandler !== "undefined") ? config.importHandler
									: function(item) {
										var gr = item.up().up();
						...
						var export_graph = {
							...
							text : "Export",
							height : myHeight,
							handler : (typeof config.exportHandler !== "undefined") ? config.exportHandler
									: function(item) {
										var gr = item.up().up();
						...
						var grid_default = {
							...
							handler : (typeof config.layout_grid_default !== "undefined") ? config.layout_grid_default
									: function(item) {
										var gr = item.up().up();
						...
						var hierarch_circle = {
							...
							handler : (typeof config.layout_heirarch_circle !== "undefined") ? config.layout_heirarch_circle
									: function(item) {
										var gr = item.up().up();

										gr.GraphVis.changeLayout(
												"breadthfirst", {
													circle : true
												});
									}
						...
						var hierarch_default = {
							...
							height : myHeight,
							width : myWidth,
							pressed : true, // <-- because Hierarchy is
											// currently default layout
							tooltip : "Hierarchy layout - Default",
							toggleGroup : config.id + "-toolbarLayouts",
							cls : "hierarch_default_btn",
							handler : (typeof config.layout_hierarch_default !== "undefined") ? config.layout_hierarch_default
									: function(item) {
										var gr = item.up().up();
						...
						var cose_anim = {
							...
							toggleGroup : config.id + "-toolbarLayouts",
							cls : "cose_anim_btn",
							handler : (typeof config.layout_cose_anim !== "undefined") ? config.layout_cose_anim
									: function(item) {
										var gr = item.up().up();
						...
						var cose_unanim = {
							...
							toggleGroup : config.id + "-toolbarLayouts",
							cls : "cose_unanim_btn",
							handler : (typeof config.layout_cose_unanim !== "undefined") ? config.layout_cose_unanim
									: function(item) {
										var gr = item.up().up();
						...
						var arbor_anim = {
							...
							toggleGroup : config.id + "-toolbarLayouts",
							cls : "arbor_anim_btn",
							handler : (typeof config.layout_arbor_anim !== "undefined") ? config.layout_arbor_anim
									: function(item) {
										var gr = item.up().up();
						...
						var arbor_unanim = {
							...
							handler : (typeof config.layout_arbor_unanim !== "undefined") ? config.layout_arbor_unanim
									: function(item) {
										var gr = item.up().up();
						...
						var arbor_wheel_anim = {
							...
							handler : (typeof config.layout_arbor_wheel_anim !== "undefined") ? config.layout_arbor_wheel_anim
									: function(item) {
										var gr = item.up().up();
						...
						var arbor_wheel_unanim = {
							...
							handler : (typeof config.layout_arbor_wheel_unanim !== "undefined") ? config.layout_arbor_wheel_unanim
									: function(item) {
										var gr = item.up().up();
						...
						var snap_btn = {
							...
							handler : (typeof config.reset == "function") ? config.reset
									: function(item) {
										var gr = item.up().up();
										gr.GraphVis.gv.fit();
									}
						...
						var help_btn = {
							...
							handler : (typeof config.help !== "undefined") ? config.help
									: function(item) {
										Ext.Msg
												.alert(
														"Toolbar Help",
														"<b>Store</b> - Persist any changes you have made so that any future similar queries will have these changes by default."
																+ "<br>"
																+ "<b>Save</b> - Save the state of your session to be loaded exactly as-is in a future session."
																+ "<br>"
																+ "<b>Load</b> - Load a saved session to replace all the queries and graph state of your current session."
																+ "<br>"
																+ "<b>Import</b> - Import a JSONized graph to replace the graph currently displayed."
																+ "<br>"
																+ "<b>Export</b> - Export your current graph as a .PNG image, a .JSON file, or an .XML file for use elsewhere."
																+ "<br>"
																+ "<hr>" +
																...
																"<img src='"
																+ Config.coreImagesUrl
																+ "hierarchy_icon.png'></img><img src='"
																+ Config.coreImagesUrl
																+ "hierarchy_circle_icon.png'></img>"
																+ "<b>Hierarchy</b> - "
																...
																"<img src='"
																+ Config.coreImagesUrl
																+ "cose_icon.png'></img><img src='"
																+ Config.coreImagesUrl
																+ "cose_animated_icon.png'></img>"
																+ "<b>COSE</b> - "
																...
																"<img src='"
																+ Config.coreImagesUrl
																+ "arbor_icon.png'></img><img src='"
																+ Config.coreImagesUrl
																+ "arbor_animated_icon.png'></img>"
																+ "<b>Arbor (default)</b> - "
																...
																"<img src='"
																+ Config.coreImagesUrl
																+ "arbor_wheel_icon.png'></img><img src='"
																+ Config.coreImagesUrl
																+ "arbor_wheel_animated_icon.png'></img>"
																+ "<b>Arbor (wheel)</b> - "

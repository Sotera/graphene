...
var GLegend = {
    ...
    createLegend: function() {        
        ...
        if (self.legendItems.length == 0 ) {    // Create only once
            ...
            legendItem = self.addLegendItem("Green", "Loan.", "lime", "small");
            self.legendItems.push(legendItem);

            legendItem = self.addLegendItem("Salmon", "Lender.", "sandybrown", "small");         
            self.legendItems.push(legendItem);

            legendItem = self.addLegendItem("Light Blue", "Borrower.", "lightblue", "small");         
            self.legendItems.push(legendItem);

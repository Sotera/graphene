		 ...
		 renderer:function(value,metadata,record) 
                  ...
                  doSort: function(state) {
                      ...
                      ds.sort( {
                          ...
                          direction: state,
                          sorterFn: function(v1, v2) {
                              var value1 = v1.get(field);
                              var str1 = "";
                              var i;
                                for (i = 0; i < value1.length; ++i) {
                                    if (value1[i].family == 'Event') {
                                        str1 += value1[i].value;
                                ...
                                var value2 = v2.get(field);
                                var str2 = "";
                                for (i = 0; i < value2.length; ++i) {
                                    if (value2[i].family == 'Event') {
                                        str2 += value2[i].value;

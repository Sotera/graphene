 ...
 * @since 2.1.1
 * @see <a
 *      href="http://jqueryui.com/demos/datepicker">http://jqueryui.com/demos/datepicker</a>
 * 
 * @tapestrydoc
 */
public class CustomDatepicker {
	...
	void afterRender() {
		/*
		 * If the selector parameter is not bound, we will use the clientId of
		 * the component using the mixin
		 */
		 ...
		 * for the CustomDatepicker mixin
		 */
		defaultParamsObject = new JSONObject();

		JSONObject temp = widgetParams.paramsForWidget(this.getClass()
	...
	private String toJQueryUIDateFormat() {
		...
		if (format == null) {
			...
			// Don't know how to extract the date pattern from this type of
			// DateFormat.
			throw new IllegalArgumentException("Type is "

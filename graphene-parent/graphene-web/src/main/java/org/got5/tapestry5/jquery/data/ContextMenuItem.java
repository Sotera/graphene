...
public class ContextMenuItem {
	 ...
	 * 
	 * For example, if event=copy, you will write the following handler to catch
	 * the click event on the menu item:
	 * 
	 * @OnEvent(value="copy") private void copyData() { ... }
	 */
	public String event;
	 ...
	 * 
	 * .context-menu-item.icon-cutData { background-image:
	 * url(images/cutData.png); }
	 * 
	 * Several icons already exist in jquery.contextMenu.css: edit, cut, copy,
	 * paste, delete, add, quit
	 */
	public String icon;

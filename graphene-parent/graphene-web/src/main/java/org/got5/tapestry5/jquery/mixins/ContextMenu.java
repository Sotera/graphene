...
public class ContextMenu {
	...
	/**
	 * Items to be listed in contextMenu. No Default Value - specification is
	 * Mandatory.
	 */
	...
	/**
	 * Specifies the event to show the contextMenu. Possible values: "right",
	 * "left", "hover", "none".
	 * 
	 * @default right
	 */
	...
	/**
	 * Specifies the time in milliseconds to wait before showing the menu. Only
	 * applies to trigger="hover".
	 * 
	 * @default 200
	 */
	...
	/**
	 * Specifies if the menu must be hidden when the mouse pointer is moved out
	 * of the trigger and menu elements.
	 * 
	 * @default false
	 */
	...
	/**
	 * Specifies the offset to add to the calculated zIndex of the trigger
	 * element. Set to 0 to prevent zIndex manipulation.
	 * 
	 * @default 1
	 */
	...
	/**
	 * The context for each link of the menu. This list of values will be
	 * converted into strings and included in the URI. The strings will be

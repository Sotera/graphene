...
/**
 * 
 * The selector: binding prefix, returns the jQuery selector for child component
 * via its id.
 * 
 * @since 2.6.0
 */
public class SelectorBinding extends AbstractBinding {
	...
	public SelectorBinding(Location location, String description,
			ComponentResources componentResources, String value,
			RenderTracker selectorTracker, String alias) {
		super(location);
	...
	public Object get() {
		...
		if (c == null) {
			throw new IllegalArgumentException(
					"Can't find id for selector binding:" + tid);
		}

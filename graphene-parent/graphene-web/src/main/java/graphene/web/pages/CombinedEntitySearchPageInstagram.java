...
public class CombinedEntitySearchPageInstagram extends SimpleBasePage implements LinkGenerator {
	@Inject
	...
	@InjectPage
	private CombinedEntitySearchPageInstagram searchPage;
	...
	public String getFormattedAmount() {
		...
		final String amount = formatter.format(getAmount());
		// if (amount.charAt(0) == '$') {

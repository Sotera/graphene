...
public class ShiroLDAPSecurityModule {
	...
	public static void contributeSecurity(final Configuration<Realm> configuration,
		...
		final JndiLdapRealm ldapRealm = new JndiLdapRealm();
		ldapRealm.setUserDnTemplate("uid={0},ou=Users,dc=mycompany,dc=com");
		final JndiLdapContextFactory contextFactory = ((JndiLdapContextFactory) ldapRealm.getContextFactory());
		contextFactory.setUrl("ldap://localhost:10389");
		contextFactory.setAuthenticationMechanism("DIGEST-MD5");
		// cbrunato
		// c2VjcmV0
